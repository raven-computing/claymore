...
/**
 * A Column holding short values.<br>
...
public final class ShortColumn extends Column {
    ...
    /**
     * Constructs a <code>ShortColumn</code> with the specified length.<br>
     * All column entries are set to default short values
     * 
     * @param length The initial length of the column to construct
     */
    public ShortColumn(final int length){
    ...
    /**
     * Constructs a <code>ShortColumn</code> with the specified label
     ...
     * @param length The initial length of the column to construct
     */
    public ShortColumn(final String name, final int length){
        this(length);
        if((name == null) || (name.isEmpty())){
            throw new IllegalArgumentException("Column name must not be null or empty");
        }
    ...
    public Column clone(){
        ...
        return ((name != null) && !name.isEmpty())
                ? new ShortColumn(name, clone)
                : new ShortColumn(clone);
    }
