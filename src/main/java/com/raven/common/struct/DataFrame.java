 ...
 * type <code>Column</code>, creating a DataFrame composed of the given columns, and a 
...
public interface DataFrame extends Cloneable, Iterable<Column> {
	...
	/**
	 * Assigns all columns the specified names. Any already set name will get overridden. Make sure
	...
	/**
	 * Indicates whether this DataFrame has any column names set. Please note that this method returns
	 ...
	 * null values to match the largest column.
	 * 
	 * <p>If the added column was labeled during its construction, then the label will get 
	 * overridden by the specified name.
	 * 
	 ...
	 * missing entries with null values to match the largest column.
	 * 
	 * <p>If the inserted column was labeled during its construction, then the label will get 
	 * overridden by the specified name.
	 * 
	 ...
	 * 
	 * <p>If the specified column has a label associated with it, then that label will be incorporated
	 * into the DataFrame. If the provided column is not labeled, then the label of the provided column
	 * will be set to the label of the replaced column
	 * 
	...
	/**
	 * Returns a hash code value for this DataFrame. This method has to be provided by all 
	 * DataFrame implementations in order to fulfill the general contract of 
	...
	/**
	 * Indicates whether this DataFrame's column structure and content is equal to the
	 * structure and content of the specified DataFrame. In that regard the order and types
	 * of the underlying columns matter
	 * 
