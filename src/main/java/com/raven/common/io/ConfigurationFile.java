...
public class ConfigurationFile implements Iterable<ConfigurationFile.Section> {
    ...
    /**
     * Sets the name of the specified configuration section to the new name
     * 
     * @param name The current name of the configuration Section
     * @param newName The new name of the configuration Section
     */
    public void setSectionName(String name, final String newName){
        name = name.trim();
        if(name.startsWith("[")){
        ...
        final Section section = getSection(name);
        if(section != null){
            section.setName(newName);
            if(sections.remove(name) != null){
                final int i = this.content.indexOf(name);
                this.content.set(i, newName);
            }
    ...
    /**
     * Gets an {@link Instant} object indicating the date and time the file this 
    ...
    public static class Section implements Iterable<Item<String>> {
         ...
         * @return This <code>ConfigurationFile.Section</code> instance
         */
        public Section set(final String key, final String value){
    ...
    /**
     * An iterator over configuration file entries in a specific <code>Section</code>.<br>
     * Enables a ConfigurationFile.Section to be target of the for-each-loop.
     * 
     * @since 3.0.0
     *
     */
    private static class EntryIterator implements Iterator<Item<String>> {
        ...
        /**
         * Constructs a new <code>EntryIterator</code>
         * 
         * @param section The <code>ConfigurationFile.Section</code> to iterate through
         */
        private EntryIterator(final Section section){
        ...
        public Item<String> next(){
            ...
            return new WritableItem<String>(e.getKey(), e.getValue());
        }
    }
